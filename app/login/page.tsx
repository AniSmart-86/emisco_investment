      ...
      >
        <div className="bg-card border border-border/50 rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground italic">Login to manage your fleet parts.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link href="#" className="text-[10px] font-bold text-pure-green uppercase hover:underline">Forgot?</Link>
              </div>
              <div className="relative">
            ...
            <Button type="submit" size="lg" disabled={isLoading} className="w-full bg-pure-green hover:bg-pure-green-hover text-white py-8 rounded-2xl text-lg font-bold group">
          ...
          <p className="text-center mt-10 text-sm text-muted-foreground">
            ...
            <Link href={`/register${callbackUrl ? `?callbackUrl=${encodeURIComponent(callbackUrl)}` : ''}`} className="text-pure-green font-bold hover:underline">Create one</Link>
          </p>
        </div>
      </motion.div>
    </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center font-bold text-pure-green">Loading Emisco...</div>}>
      <LoginForm />
    </Suspense>
  );
}
