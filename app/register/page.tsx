      ...
      >
        <div className="bg-card border border-border/50 rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground italic">Join Emisco for premium truck maintenance.</p>
          </div>
          ...
          <p className="text-center mt-10 text-sm text-muted-foreground">
            ...
            <Link href={`/login${callbackUrl ? `?callbackUrl=${encodeURIComponent(callbackUrl)}` : ''}`} className="text-pure-green font-bold hover:underline">Sign In</Link>
          </p>
        </div>
      </motion.div>
    </div>
