          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-card border border-border p-10 rounded-[2.5rem] shadow-sm">
               ...
               <div className="space-y-2">
                  <a href="tel:08082013145" className="block text-md font-bold hover:text-pure-green hover:translate-x-1 transition-all">Click: 0808 201 3145</a>
                  <a href="tel:08135580669" className="block text-md font-bold hover:text-pure-green hover:translate-x-1 transition-all">Click: 0813 558 0669</a>
               </div>
            </div>
               ...
               <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-muted/30 border border-border rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-pure-green/50" 
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-muted/30 border border-border rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-pure-green/50 resize-none" 
                  ...
                  <div className="md:col-span-2 pt-4">
                    <Button 
                      ...
                      className="w-full bg-pure-green hover:bg-pure-green-hover text-white py-8 rounded-2xl text-xl font-bold group"
                    >
